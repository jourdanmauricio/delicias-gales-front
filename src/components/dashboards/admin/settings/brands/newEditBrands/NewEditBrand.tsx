...
const NewEditBrand = ({ brand, handleCancel, handleRefresh, action }) => {
  const { data, selectedFile, preview, loading, errors, onSelectFile, handleChange, handleSubmit } = useNewEditBrand({ brand, handleRefresh, action });
